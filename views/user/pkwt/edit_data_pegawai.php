...
<div id="content">
   <div class="panel box-shadow-none content-header">
	...
	<form class="form-element" method="post" action="<?php echo base_url()?>user/pegawai_pkwt/proc_edit?id=<?php echo $row['id_peg']?>" autocomplete="off" >
			 ...
			 <div class="panel-body" style="padding-bottom:30px;">
			  <div class="col-md-10">
				...
				<div class="form-group"><label class="col-sm-2 control-label text-right">No. Kontrak</label>
				  <div class="col-sm-4"><input type="text" name="no_kontrak" maxlength="20" value="<?php echo $row['no_kontrak']?>" class="form-control" readonly></div>
				</div>
				<div class="form-group"><label class="col-sm-2 control-label text-right">NIP</label>
				  <div class="col-sm-4">
				    <select name="nip" class="form-control" readonly>
				...
				<div class="form-group"><label class="col-sm-2 control-label text-right">Bidang</label>
				  <div class="col-sm-4 padding-20">
					<select name="id_bid" class="form-control" readonly>
				...
				<div class="form-group"><label class="col-sm-2 control-label text-right">Jabatan</label>
				  <div class="col-sm-4 padding-20">
					<select name="id_jab" class="form-control" readonly>
				...
				<div class="form-group"><label class="col-sm-2 control-label text-right">Direktorat</label>
				  <div class="col-sm-4 padding-20">
					<select name="id_direktorat" class="form-control" readonly>
				...
				<div class="form-group"><label class="col-sm-2 control-label text-right">Mulai Kontrak</label>
				  <div class="col-sm-4"><input type="date" name="mulai_kontrak" maxlength="20" value="<?php echo $row['mulai_kontrak']?>" class="form-control" readonly ></div>                            
				</div>
				<div class="form-group"><label class="col-sm-2 control-label text-right">Berakhir Kontrak</label>
				  <div class="col-sm-4"><input type="date" name="berakhir_kontrak" maxlength="20" value="<?php echo $row['berakhir_kontrak']?>" class="form-control" readonly ></div>
				</div></br>
				<div class="form-group"><label class="col-sm-2 control-label text-right">Uang Tugas</label>
				  <div class="col-sm-4"><input type="text" name="uang_tugas" maxlength="20" value="<?php echo $row['uang_tugas']?>" class="form-control" readonly ></div>
				</div>
				<div class="form-group"><label class="col-sm-2 control-label text-right">Uang Insentif</label>
				  <div class="col-sm-4">
				  <input type="text" name="uang_insentif" maxlength="20" value="<?php echo $row['uang_insentif']?>" class="form-control" readonly ></div>
				</div>
				<div class="form-group"><label class="col-sm-2 control-label text-right">Uang Makan</label>
				  <div class="col-sm-4"><input type="text" name="uang_makan" maxlength="20" value="<?php echo $row['uang_makan']?>" class="form-control" readonly ></div>
				</div> 
				<div class="form-group"><label class="col-sm-2 control-label text-right">Uang Transport</label>
				  <div class="col-sm-4"><input type="text" name="uang_transport" maxlength="20" value="<?php echo $row['uang_transport']?>" class="form-control" readonly ></div>
				</div>                            
				...
				<div class="form-group"><label class="col-sm-2 control-label text-right">Tempat Lahir</label>
				  <div class="col-sm-4"><input type="text" name="tempat_lahir" maxlength="20" value="<?php echo $row['tempat_lahir']?>" class="form-control" readonly></div>
				</div>
				<div class="form-group"><label class="col-sm-2 control-label text-right">Tanggal Lahir</label>
				  <div class="col-sm-4"><input type="date" name="tgl_lahir" maxlength="20" value="<?php echo $row['tgl_lahir']?>" class="form-control" readonly></div>
				  </div>
