...
<div id="content">
   <div class="panel box-shadow-none content-header">
	...
	<form class="form-element" method="post" action="<?php echo base_url()?>admin/data_pendidikan/proc_edit_pendidikan?id=<?php echo $dp['id_pen']?>" autocomplete="off" >
	  ...
	  <div class="col-md-11 padding-2">
		<div class="col-md-20">
		  <div class="panel form-element-padding">
			...
			<div class="col-md-10">        
			  <div class="col-sm-2"><input type="hidden" name="id_peg" maxlength="20" value="<?php echo $dp['id_peg']?>" class="form-control" readonly="readonly"></div>
			  <div class="form-group"><label class="col-sm-2 control-label text-right">Tingkat Pend./Jurusan</label>
				<div class="col-sm-6"><input type="text" name="tingkat_pen" maxlength="48" value="<?php echo $dp['tingkat_pen']?>" class="form-control" required></div>
			  </div>
			  ...
			  <div class="form-group"><label class="col-sm-2 control-label text-right">Lembaga Pendidikan</label>
				<div class="col-sm-10"><textarea name="lembaga_pen" cols="20" rows="2" class="form-control" required><?php echo $dp['lembaga_pen']?></textarea></div>
			  </div></br></br>
			  <div class="form-group"><label class="col-sm-2 control-label text-right">Gelar Akademik</label>
				<div class="col-sm-6"><input type="text" name="gelar_pen" maxlength="48" value="<?php echo $dp['gelar_pen']?>" class="form-control"></div>
			  </div>						  
...
<script>
  ...
  var options = "";
  for (i=1; i<=1; i++) {
  options += "<option>"+ <?php echo $dp['tahun_pen'] ?> +"</option>";		
