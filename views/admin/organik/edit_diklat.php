	  ...
	  <div class="col-md-11 padding-2">
		<div class="col-md-20">
		  <div class="panel form-element-padding">
			...
			<div class="col-md-10">
			  <div class="col-sm-2"><input type="hidden" name="id_peg" maxlength="20" value="<?php echo $dd['id_peg']?>" class="form-control" readonly="readonly"></div>
			  <div class="form-group"><label class="col-sm-2 control-label text-right">Nama Diklat</label>
				<div class="col-sm-10"><textarea name="nama_dik" cols="20" rows="2" class="form-control" required><?php echo $dd['nama_dik']?></textarea></div>
			  </div></br></br>
			  <div class="form-group"><label class="col-sm-2 control-label text-right">Jenis Diklat</label>
				<div class="col-sm-4"><input type="text" name="jenis_dik" maxlength="50" value="<?php echo $dd['jenis_dik']?>" class="form-control" required></div>
			  </div>
...
<script>
  ...
  var options = "";
  for (i=1; i<=1; i++) {
  options += "<option>"+ <?php echo $dd['tahun_dik'] ?> +"</option>";		
