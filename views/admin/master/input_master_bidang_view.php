                  ...
                  <div class="panel-body">
                    <div class="col-md-12">
                        ...
                        <p class="animated fadeInDown">
                          Bidang <span class="fa-angle-right fa"></span> Tambah Bidang
                        </p>
                    </div>
                  </div>
                </div>
                <form class="form-element" method="post" action="<?php echo base_url() ?>admin/Master_bidang/proc_input" autocomplete="off" >
                        ...
                        <div class="panel-heading">
                         ...
                         <div class="panel-body" style="padding-bottom:30px;">
                          <div class="col-md-10">                            
                            ...
                            <div class="form-group"><label class="col-sm-2 control-label text-right">Nama Bidang</label>
                              <div class="col-sm-6"><input type="text" name="nama_bid" maxlength="50" class="form-control" required ></div>
                            </div>                            
                            ...
                            ?>
                              <div class="col-sm-4"><input type="hidden" name="id_bid" maxlength="20" class="form-control" value="<?php echo $nextid?>" readonly></div>
                            </div>                          
