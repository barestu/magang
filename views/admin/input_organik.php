<!-- isi data pegawai-->
	<div id="content">
	   <div class="panel box-shadow-none content-header">
		...
		<form class="form-element" method="post" action="<?php echo base_url()?>admin/pegawai_organik/proc_input" autocomplete="off" >
				 ...
				 <div class="panel-body" style="padding-bottom:30px;">
				  <div class="col-md-10">
					...
					<div class="form-group"><label class="col-sm-2 control-label text-right">Tanggal Masuk</label>
					  <div class="col-sm-4"><input type="date" name="tgl_masuk" maxlength="20" class="form-control" required ></div>                            
					</div>
					<div class="form-group"><label class="col-sm-2 control-label text-right">Tanggal Angkat</label>
					  <div class="col-sm-4"><input type="date" name="tgl_angkat" maxlength="20" class="form-control" required ></div>
					</div>                            
