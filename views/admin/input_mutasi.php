...
<div id="content">
   <div class="panel box-shadow-none content-header">
	  <div class="panel-body">
		<div class="col-md-12">
			<h3 class="animated fadeInLeft">Input Mutasi/Riwayat Profesi Pegawai</h3>
	...
	<form class="form-element" method="post" action="<?php echo base_url()?>admin/data_mutasi/proc_input_mutasi" autocomplete="off" >
		  ...
		  <div class="panel form-element-padding">
			...
			<div class="col-md-10">
			  ...
			  <div class="form-group"><label class="col-sm-2 control-label text-right">Nama Profesi</label>
				<div class="col-sm-10"><textarea name="nama_mut" cols="20" rows="2" class="form-control" required></textarea></div>
			  </div></br></br>
			  <div class="form-group"><label class="col-sm-2 control-label text-right">Sejak</label>
				<div class="col-sm-4"><input type="date" name="tgl_sejak" maxlength="20" class="form-control" required></div>
			  </div>
			  <div class="form-group"><label class="col-sm-2 control-label text-right">Hingga</label>
				<div class="col-sm-4"><input type="date" name="tgl_hingga" maxlength="20" class="form-control" required></div>
			  </div></br></br>
