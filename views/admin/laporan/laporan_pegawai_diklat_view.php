<div id="content" class="kontent">
          ...
          <div class="panel-body">
            <div class="col-md-12">
			  <h3 class="animated fadeInLeft">
			    <span class="icon-graduation"></span> Diklat 
			  </h3>
              <p class="animated fadeInDown">
                Laporan Pegawai <span class="fa-angle-right fa"></span> Pendidikan & Pelatihan 
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-12">
            ...
            <div class="panel-body">
                ...
                echo form_open("admin/Laporan_pegawai_diklat/proc_laporan",'class="form-element" autocomplete="off"');
                ?>
                    ...
                    <div class="col-md-20">
                      <div class="panel form-element-padding">
                        <div class="panel-heading">                                                                     
                            ...
                            <h4>Laporan Pendidikan & Pelatihan :</h4> 
        ...
        if (!empty($row['nip'])) { ?>
       <div class="col-sm-2 padding-20"><a class="btn btn-success" href="<?php echo base_url();?>admin/Laporan_pegawai_diklat/export_laporan "><i class="fa fa-file-excel-o"></i> Export ke Excell</a><br><br></div> 
       <?php }}?>				
        <div class="responsive-table">
            ...
            echo "<tr>
                  ...
                  <td class='mid'>$nama_dik</td>
                  <td class='mid'>$jenis_dik</td>
                  <td class='mid'>$tahun_dik</td>                                 
                </tr>";
            $no++;
            }}
            ?>
