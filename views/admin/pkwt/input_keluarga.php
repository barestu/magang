	  ...
	  <div class="panel-body">
		<div class="col-md-12">
			...
			<p class="animated fadeInDown">
			  Data Pegawai <span class="fa-angle-right fa"></span> Data Pegawai PKWT <span class="fa-angle-right fa"></span> Data Keluarga Pegawai
			</p>
		</div>
	  </div>
	</div>
	<form class="form-element" method="post" action="<?php echo base_url()?>admin/data_keluarga/proc_input_keluarga_pkwt" autocomplete="off" >
		  ...
		  <div class="panel form-element-padding">
			...
			<div class="panel-body">
			  ...
			  <div class="form-group"><label class="col-sm-2 control-label text-right">Tanggal Lahir</label>
				<div class="col-sm-4"><input type="date" name="tgl_kel" maxlength="20" class="form-control" required ></div>                            
			  </div>  
