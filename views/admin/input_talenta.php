...
<div id="content">
	   <div class="panel box-shadow-none content-header">
		...
		<form class="form-element" method="post" action="<?php echo base_url()?>admin/data_talenta/proc_input_talenta" autocomplete="off" >
			  ...
			  <div class="panel form-element-padding">
				<div class="panel-heading">
				 ...
				 <div class="panel-body" style="padding-bottom:30px;">
				  <div class="col-md-10">
					<div class="col-sm-4"><input type="hidden" value="<?php echo $id_peg?>" name="id_peg" maxlength="20" class="form-control" readonly ></div>                         
					<div class="form-group"><label class="col-sm-2 control-label text-right">Mulai tanggal</label>
					  <div class="col-sm-4"><input type="date" name="mulai_tanggal" maxlength="20" class="form-control" required ></div>
					</div>
					<div class="form-group"><label class="col-sm-2 control-label text-right">Berakhir Tanggal</label>
					  <div class="col-sm-4"><input type="date" name="berakhir_tanggal" maxlength="20" class="form-control" required ></div>
					</div>
					<div class="form-group"><label class="col-sm-2 control-label text-right">Semester</label>
					  <div class="col-sm-4"><input type="text" name="semester" pattern="[0-9]{1,}" title="Isi Hanya Angka" maxlength="20" class="form-control" required ></div>
					</div>
					...
					<div class="form-group"><label class="col-sm-2 control-label text-right">Poin</label>
					  <div class="col-sm-4"><input type="text" name="poin" maxlength="48"  class="form-control"></div>
					</div></br></br>
