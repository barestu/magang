<div id="content" class="kontent">
          ...
          <div class="panel-body">
            <div class="col-md-12">
			  <h3 class="animated fadeInLeft">
			    <span class="icon-badge"></span> Data Talenta 
			  </h3>
              <p class="animated fadeInDown">
                Laporan Pegawai <span class="fa-angle-right fa"></span> Data Talenta 
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-12">
            ...
            <div class="panel-body">
                ...
                echo form_open("admin/Laporan_pegawai_talenta/proc_laporan",'class="form-element" autocomplete="off"');
                ?>
                    ...
                    <div class="col-md-20">
                      <div class="panel form-element-padding">
                        <div class="panel-heading">                                                                     
                            ...
                            <h4>Laporan Data Talenta Pegawai :</h4> 
        ...
        if (!empty($row['nip'])) { ?>
       <div class="col-sm-2 padding-20"><a class="btn btn-success" href="<?php echo base_url();?>admin/Laporan_pegawai_talenta/export_laporan "><i class="fa fa-file-excel-o"></i> Export ke Excell</a><br><br></div> 
       <?php }}?>				
