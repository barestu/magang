<div id="content" class="kontent">
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Informasi Akun</h3>
                        <p class="animated fadeInDown">
                          Manajemen User <span class="fa-angle-right fa"></span> Tambah User
                        </p>
                    </div>
                  </div>
                </div>
                         ...
                         <div class="panel-body" style="padding-bottom:30px;">
                          <div class="col-md-10">                            
                            ...
                            <div class="form-group"><label class="col-sm-2 control-label text-right">Konfirmasi Password</label>
                              <div class="col-sm-4"><input type="password" name="passwordbaru" maxlength="20" class="form-control" pattern=".{6,}" title="6 atau lebih karakter" id="txtConfirmPassword" required ></div>
                            </div>
                            ...
                            <div class="form-group"><label class="col-sm-2 control-label text-right">NIP</label>
                              <div class="col-sm-4"><input type="text" name="nip" maxlength="48" pattern="[0-9]{6}" title="Digit Angka" value="<?php echo $row['nip'] ?>" class="form-control" required ></div>
                            </div>
