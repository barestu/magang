<div class="kontent" id="content">
    ...
    <div class="panel box-shadow-none content-header">
        ...
        <h3 class="animated fadeInLeft">
          <span class="fa fa-database"></span> Manajemen User 
        </h3>
            ...
            echo "<tr>
                <td class='mid'>$no</td>
                 ...
                 <div class='btn-group' role='group'>
                  ...
                  <li><a href="<?php echo base_url(); ?>admin/Manajemen_user/aktivasi?id=<?php echo $row['id_user_login']; ?>">Aktivasi</a></li>
