<?php
class Laporan_pegawai_sertifikasi_model extends CI_Model {
...
if (!empty($where)) {
 $query = $this->db->query("SELECT nip, nama, nama_ser, tanggal_ser
FROM tbl_pegawai NATURAL JOIN tb_jabatan NATURAL JOIN tb_bidang NATURAL JOIN tb_direktorat NATURAL JOIN tb_sertifikasi
WHERE tbl_pegawai.id_bid = tb_bidang.id_bid 
AND tbl_pegawai.id_direktorat = tb_direktorat.id_direktorat 
AND tbl_pegawai.id_peg = tb_sertifikasi.id_peg 
...
if (!empty($where)) {
 $query = $this->db->query("SELECT nip, nama, nama_ser, tanggal_ser, nama_direktorat, nama_jab, nama_bid
FROM tbl_pegawai NATURAL JOIN tb_jabatan NATURAL JOIN tb_bidang NATURAL JOIN tb_direktorat NATURAL JOIN tb_sertifikasi 
WHERE tbl_pegawai.id_bid = tb_bidang.id_bid 
AND tbl_pegawai.id_direktorat = tb_direktorat.id_direktorat 
AND tbl_pegawai.id_peg = tb_sertifikasi.id_peg 
