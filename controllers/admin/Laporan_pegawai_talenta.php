...
class Laporan_pegawai_talenta extends CI_Controller {
	...
	public function __construct() {
		...
		$this->load->model('Laporan_pegawai_talenta_model');
	}
	...
	public function proc_laporan() {
		...
		$isi = array('title' => 'SIPEG',
 			...
 			'view_jabatan' => $this->Laporan_pegawai_talenta_model->list_jabatan(),
 			'view_bidang' => $this->Laporan_pegawai_talenta_model->list_bidang(),
 			'view_laporan' => $this->Laporan_pegawai_talenta_model->proc_laporan(),
 			'username' => $this->session->userdata('username'));
